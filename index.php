...
<body style="background-image: url('img/iiitn.jpg');background-repeat:no-repeat;background-size: 100% 100%;">
      ...
      style="min-height: 100vh;" >
      	<form class="border shadow p-3 rounded"
      	      ...
      	      method="post" 
      	      style="width: 450px; background-color:#05010191">
      	      <h1 style="text-color:white;" >LOGIN</h1>
		  ...
		  <div class="mb-3" >
		    ...
		    <input type="text" 
		           class="form-control" 
		           name="userid" 
		           id="userid" style="background-color:#05010191">
		  </div>
		  <div class="mb-3">
		    <label for="password" 
